...
def display_world_all_pos(world_size, position, landmarks=None):
    ...
    for i in range(1,len(position)):
        ax.plot([position[i-1][0],position[i][0]], [position[i-1][1],position[i][1]],'r-')
        
        ax.plot([position[i][0],position[i][0]], [position[i-1][1],position[i][1]],'b-')
        ax.plot([position[i-1][0],position[i][0]], [position[i-1][1],position[i-1][1]],'b-')
    ...
    # ha = horizontal alignment, va = vertical
    for p in position:
        ax.text(p[0], p[1], 'o', ha='center', va='center', color='r', fontsize=30)
    
    ax.text(position[0][0], position[0][1]+2, 'start', ha='center', va='center', color='r', fontsize=30)
    ax.text(position[-1][0], position[-1][1]+2, 'endpoint', ha='center', va='center', color='r', fontsize=30)
    
    #ax.plot([50,60],[50,70],'r-')
...
def make_data_2(N, num_landmarks, world_size, measurement_range, motion_noise, 
              measurement_noise, distance):
